class Contact < ApplicationRecord
  # Associations 
    # relationship to other models
      ...
      # dependent
      # needed option 
      # only be in has_many or has_one
  ...
  # Validations
    ...
    # confirmation 
      # makes sure 2 fields in the form is matching
    # inclustion 
      # makes sure that a field is included with in a given set 
    # length
      # how many characters you are letting them pass in for a field, like "password must be 10 characters long"
    # numericality 
      # make sure a field is a type of number, 
    # presence 
      # make sure that you are not passing in an empty field, use rmust enter info such as name, email, login
    # uniqueness  
      # makes sure that it is the only value that is unique, example: makes sure chosen email i sthe only email in that database 

    validates :first_name, :lsat_name, :age, :email, :phone, :friend, presence: true
    ...
    # Callbacks
      # -trigger logic based off of an event 
        ...
        # before_save
        # after_save
        # around_save - it'll happen before and after save
        # before_create
        # after_create
        # around_create 
